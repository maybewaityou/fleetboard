...
// SearchBar is the fuzzy-search input above the account list. Ported from
// lazytmux/search_bar.go; only the label/placeholder copy differs. It forwards
// every keystroke via OnSearch and hands focus back to the list on arrow/enter.
